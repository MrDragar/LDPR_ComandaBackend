...
class IPetitionService(ABC):
    @abstractmethod
    async def create_petition(self, user_id: int, source: str, title: str, description: str, image_url: str | None, scope: str) -> Petition: ...
    @abstractmethod
    async def get_petition(self, petition_id: int, user_id: int | None, source: str | None) -> dict: ...

    @abstractmethod
    async def get_feed(self, user_id: int, source: str, scope: str | None, region: str | None,
                       limit: int) -> list[dict]: ...
...
class ICandidateService(ABC):
    ...
    @abstractmethod
    async def ask_question(self, candidate_id: int, author_id: int, author_source: str, text: str, is_anonymous: bool) -> dict: ...
...
class IAdminCandidateService(ABC):
    @abstractmethod
    async def create_candidate(self, user_id: int, source: str, fio: str, region: str, photo_url: str | None, 
                               bio: str | None, topics: list[str], social_links: dict[str, str]) -> dict: ...


class ICabinetPetitionService(ABC):
    @abstractmethod
    async def get_petitions(self, user_id: int, source: str, status: str, page: int, limit: int) -> dict: ...
    @abstractmethod
    async def take_petition(self, user_id: int, source: str, petition_id: int, initial_comment: str) -> dict: ...
    @abstractmethod
    async def update_progress(self, user_id: int, source: str, petition_id: int, comment: str) -> dict: ...
    @abstractmethod
    async def complete_petition(self, user_id: int, source: str, petition_id: int, result: str, result_image_url: str | None) -> dict: ...


class ICabinetQuestionService(ABC):
    @abstractmethod
    async def get_questions(self, user_id: int, source: str, status: str | None, page: int, limit: int) -> dict: ...
    @abstractmethod
    async def answer_question(self, user_id: int, source: str, question_id: int, text: str | None, voice_url: str | None, video_url: str | None) -> dict: ...
