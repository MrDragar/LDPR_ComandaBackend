...
from src.domain.interfaces import (IUnitOfWork, IUserRepository, IStringSorterRepository,
                                   ...
                                   ICandidateQuestionRepository, IStatsRepository, IHillRepository)
...
class Container(DeclarativeContainer):
    ...
    hill_repository: providers.Factory[IHillRepository] = providers.Factory(HillRepository, uow=uow)
    ...
    auth_service: providers.Factory[IAuthService] = providers.Factory(
        ...
        max_auth_repo=max_auth_repository, uow=uow, group_link=config.GROUP_LINK,
        log_chat=config.log_chat, notification_service=notification_service
    )
    ...
    hill_service: providers.Factory[IHillService] = providers.Factory(
        HillService, hill_repo=hill_repository, uow=uow
    )
